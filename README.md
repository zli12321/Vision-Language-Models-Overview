...
|--------------------------------------------------------------|------|----------------|-----------------------------|----------------|-----------------------------------------------|---------------------------------------------------|
| [S1-VL (Scientific Multimodal Reasoner)](https://arxiv.org/abs/2604.21409) | 04/23/2026 | Decoder-only / Thinking-with-Images (Python tool-use) | Scientific image corpora (charts, microscopy, plots) | 32B | Inherited (Qwen3-VL ViT) | Qwen3-VL-32B-Thinking |
