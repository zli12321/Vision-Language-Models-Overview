...
|--------------------------------------------------------------|------|----------------|-----------------------------|----------------|-----------------------------------------------|---------------------------------------------------|
| [Qwen3-VL](https://huggingface.co/docs/transformers/main/en/model_doc/qwen3_vl) | TBD | - |TBD | TBD | ViT | Qwen3](https://huggingface.co/collections/Qwen/qwen3-67dd247413f0e2e4f653967f)
